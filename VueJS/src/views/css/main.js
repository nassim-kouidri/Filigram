...
function all() {
    ...
    function onConnected() {
        ...
        var le = JSON.stringify({ sender: username, type: 'JOIN' });
        console.log("C4EST LE LET: " + le);
    ...
    function onMessageReceived(payload) {
        ...
        } else if (message.content.indexOf('blob') !== -1) {
            message.content = `<audio id="audio" controls><source src="${message.content}" type="video/webm" /></audio>`;
            document.getElementById("messageArea").innerHTML = message.content;
        } else {
    ...
    function ChangeSendIcon(control) {
        if (control.value !== '') {
            ...
            document.getElementById('send').setAttribute('display:none');
        }
    }
    //////////////////////////////////////////////////
